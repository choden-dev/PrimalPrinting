		...
		>
			...
			>
				<Image
					...
					transform="scaleX(-1)"
				/>
				<Heading fontWeight="500">{toDisplay.title}</Heading>
				<Text whiteSpace="pre-line" fontSize="lg" fontWeight="300">
					{toDisplay.description}
				</Text>
				<Box display="flex" alignItems="center">
					<a
						href="https://www.instagram.com/stories/highlights/17860217396773029/"
